const assetMap = {"airpods-4": "/manus-storage/airpods-4_4174b5b8.svg", "airpods-lite": "/manus-storage/airpods-lite_bfefa6c5.svg", "airpods-max-2": "/manus-storage/airpods-max-2_726e60ff.svg", "airpods-max-se": "/manus-storage/airpods-max-se_639c4916.svg", "airpods-mini": "/manus-storage/airpods-mini_7d9e1d64.svg", "airpods-pro-2": "/manus-storage/airpods-pro-2_629db38c.svg", "airpods-pro-3": "/manus-storage/airpods-pro-3_0acf54aa.svg", "airpods-spatial": "/manus-storage/airpods-spatial_0b441bf0.svg", "airpods-sport": "/manus-storage/airpods-sport_5743a302.svg", "airpods-studio": "/manus-storage/airpods-studio_a09c5c75.svg", "ipad-10": "/manus-storage/ipad-10_17b3c6a4.svg", "ipad-air-11": "/manus-storage/ipad-air-11_4c578528.svg", "ipad-air-13": "/manus-storage/ipad-air-13_409d5c68.svg", "ipad-flex": "/manus-storage/ipad-flex_0968034c.svg", "ipad-mini-cellular": "/manus-storage/ipad-mini-cellular_f002a209.svg", "ipad-mini": "/manus-storage/ipad-mini_5f50a59d.svg", "ipad-pro-11": "/manus-storage/ipad-pro-11_1d765d25.svg", "ipad-pro-13": "/manus-storage/ipad-pro-13_2c84e350.svg", "ipad-se": "/manus-storage/ipad-se_5a543294.svg", "ipad-studio": "/manus-storage/ipad-studio_a1461c94.svg", "iphone-12": "/manus-storage/iphone-12_b3793792.svg", "iphone-14": "/manus-storage/iphone-14_0958aa2d.svg", "iphone-15-pro": "/manus-storage/iphone-15-pro_9b2f934d.svg", "iphone-15": "/manus-storage/iphone-15_6eb0b4dc.svg", "iphone-16-pro": "/manus-storage/iphone-16-pro_c8fb1da5.svg", "iphone-16": "/manus-storage/iphone-16_a58077f5.svg", "iphone-17-air": "/manus-storage/iphone-17-air_d71195c9.svg", "iphone-17-pro-max": "/manus-storage/iphone-17-pro-max_a32e6b5d.svg", "iphone-17": "/manus-storage/iphone-17_87aa8f2a.svg", "iphone-se": "/manus-storage/iphone-se_599294b5.svg", "macbook-air-13": "/manus-storage/macbook-air-13_39661978.svg", "macbook-air-15": "/manus-storage/macbook-air-15_108a10b9.svg", "macbook-carbon": "/manus-storage/macbook-carbon_2b95683a.svg", "macbook-flex": "/manus-storage/macbook-flex_79b21b08.svg", "macbook-max": "/manus-storage/macbook-max_3dacb0c7.svg", "macbook-neo": "/manus-storage/macbook-neo_01b084fe.svg", "macbook-pro-14": "/manus-storage/macbook-pro-14_741a3a5b.svg", "macbook-pro-16": "/manus-storage/macbook-pro-16_8ef055f5.svg", "macbook-se": "/manus-storage/macbook-se_eacdf920.svg", "macbook-studio": "/manus-storage/macbook-studio_a0818e7c.svg"};
const catalog = [
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function renderProducts(filter='all', query=''){
    ...
    Object.entries(productData).forEach(([id,p])=>{const haystack=`${p.name} ${p.category} ${p.tagline} ${p.features}`.toLowerCase();if(filter!=='all'&&p.category!==filter)return;if(query&&!haystack.includes(query.toLowerCase()))return; const card=document.createElement('article'); card.className='product-card reveal visible'; card.innerHTML=`<div class="product-art"><img src="${p.image}" alt="${p.name} original concept illustration" loading="lazy"></div><h3>${p.name}</h3><p>${p.tagline}</p><small class="feature-line">${p.features}</small><div class="card-actions"><a class="card-link details" href="product.html?id=${id}" data-product="${id}">View product ↗</a><button class="card-link add-link" data-add-cart="${id}">Add to cart +</button><span class="price">From $${p.price.toLocaleString()}</span></div>`;grid.appendChild(card)});
